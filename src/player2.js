...
const Player2 = ({ showGamePlayer2 }) => {
    ...
    const [playMusicFart] = useSound(fart, {
        interrupt: true,
    });
        ...
        <div className="container-fluid">
            <div className="row">
                <div className="col text-center mb-3" style={{ color: "#ffff" }}>
                    P2 : {Character[showCharacter].name}
                </div>
            </div>
            <div className="row">
            ...
            <div className="row">
                ...
                <div className="col-4">
                    {show === true && <div className="btn style-2">
                        <i></i>
                        <i></i>
                        <i></i>
                        <i></i>
                        ...
                        <i></i>
                        <i></i>
                        <span onClick={unShowPlayer2}>Valider</span>
                    </div>}
                </div>
                <div className="col-4"></div>
            </div>
